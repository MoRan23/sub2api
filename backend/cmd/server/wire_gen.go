...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	openAIGatewayService.SetOAuthSyncSessionRepository(oauthSyncSessionRepository)
	oauthDailySessionRepository := repository.NewOpenAIOAuthDailySessionRepository(client)
	openAIGatewayService.SetOAuthDailySessionRepository(oauthDailySessionRepository)
	...
	accountTestService.SetOAuthSyncSessionRepository(oauthSyncSessionRepository)
	accountTestService.SetOAuthDailySessionRepository(oauthDailySessionRepository)
	...
	openAIOAuthHandler := admin.NewOpenAIOAuthHandler(openAIOAuthService, adminService, openAIQuotaService, rateLimitService, oauthDailySessionRepository, settingService)
