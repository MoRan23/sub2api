...
var auditSensitiveReads = map[string]string{
	...
	"GET /api/v1/admin/accounts/:id/codex-auth":                      "admin.accounts.codex_auth.export",
...
var auditBodyOmittedRoutes = map[string]struct{}{
	...
	"PUT /api/v1/admin/group-applications/email-config":            {},
	"POST /api/v1/admin/group-applications/email-config/test-smtp": {},
	"POST /api/v1/admin/group-applications/email-config/send-test": {},
	"POST /api/v1/admin/group-applications/email-config/test-imap": {},
}
