export default {
    accounts: {
      codexTurnState: {
        ...
        bundleRoutingHint: 'HTTP business requests using a valid Lite package follow the proxy that issued it. Without a usable package, requests use the account’s original proxy. Other protocols do not force a proxy change; native WebSocket is unaffected.',
