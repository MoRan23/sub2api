export default {
    ...
    affiliates: {
      ...
      transfersDescription: '查看返利额度转入赠送余额与线下提现的流水',
      errors: {
    ...
    users: {
      ...
      withdraw: '退款',
      depositAmount: '充值金额',
      ordinaryDepositAmount: '普通余额金额',
      giftDepositAmount: '赠送余额金额',
      giftDepositHint: '赠送余额独立到账，不计入累计充值和邀请返利基数。普通余额或赠送余额至少填写一项。',
      withdrawAmount: '退款金额',
      withdrawAll: '全部',
      ...
      allTypes: '全部类型',
      typeBalance: '余额（兑换码）',
      typeAffiliateBalance: '赠送余额（返利转入）',
