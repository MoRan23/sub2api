...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		EnableOpenAIRequestTimezoneConversion:                  settings.EnableOpenAIRequestTimezoneConversion,
		EnableOpenAIPassthroughTimezoneConversion:              settings.EnableOpenAIPassthroughTimezoneConversion,
		EnableOpenAICodexResidencyUS:                           settings.EnableOpenAICodexResidencyUS,
		...
		InstallationObservationEnabled:                         settings.InstallationObservationEnabled,
		...
		PaymentBalanceGiftRatio:                                paymentCfg.BalanceGiftRatio,
