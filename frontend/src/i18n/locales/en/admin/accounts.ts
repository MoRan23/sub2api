export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintCreateDesc: 'After creation, the account-level configuration combines its fixed installation_id and environment fingerprint. Global policy manages UUIDv7 sessions and client identity.',
        codexFingerprintEditDesc: 'Manage this account\'s fixed installation_id and UA environment suffix here. Global policy controls UUIDv7 session and client identity normalization.',
        ...
        codexFingerprintShadowHint: 'This shadow inherits Codex fingerprint settings from its parent account. Effective values are not displayed or submitted here; edit the parent account to change them.',
        ...
        installationPinDesc:
          'Enabled by default. When on, this account emits a dedicated UUID generated by the system at account creation and ignores the client-reported value; turning it off restores passthrough. OpenAI OAuth accounts only.',
        ...
        installationRegenerateConfirm: 'Generate a new installation_id for this account? New requests will use it.',
