export default {
  promptAudit: {
    ...
    policy: {
      title: 'Audit policy', description: 'Configure group scope, risk categories, keywords, workers, and queue bounds.', scope: 'Scope', allGroups: 'All groups', selectedGroups: 'Selected groups',
