...
func ProvideOpenAIQuotaService(
	...
	service.SetRequestPolicySettingService(settingService)
	return service
}
...
// ProvideOpenAIGatewayService wires the durable roots for both daily and legacy sync requests.
...
func ProvideAccountTestService(
	...
	service.SetOAuthSyncSessionRepository(syncSessionRepo)
	service.SetOAuthDailySessionRepository(dailySessionRepo)
	return service
}
...
// ProvideChannelCacheInvalidators adapts Wire's concrete ChannelService binding
// to NewAdminService's optional variadic invalidator dependency.
