...
func TestDuplicateAccountCopiesConfigurationAndResetsRuntimeState(t *testing.T) {
	...
	source := &Account{
		...
		Extra: map[string]any{
			...
			OpenAIRemoteCompactionV2CheckedAtExtraKey:  "2026-07-15T00:00:00Z",
			OpenAIRemoteCompactionV2LastStatusExtraKey: http.StatusNotFound,
			OpenAIRemoteCompactionV2LastErrorExtraKey:  "unsupported",
