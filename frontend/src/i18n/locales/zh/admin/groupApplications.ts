export default {
  groupApplications: {
    ...
    replyPhrase: "严格回复词",
    replyPhraseHint:
      "确认词必须单独占据邮件正文第一段，并与此字符串完全一致（包含空格和大小写）；后续段落仅可保留邮箱签名，不得包含其他正文。",
    pdfAgreement: "协议 PDF",
	...
	imapTitle: "IMAP 回信",
    imapHint: "用于读取用户对批准邮件的确认回复；确认词须独占第一段，后续仅允许邮箱签名。邮箱目录通常为 INBOX；开启安全登录时，请使用客户端专用密码而非网页登录密码。",
	...
	startTLSHint: "先建立连接，再强制升级为加密通道，常用端口 {port}；不支持升级时连接失败。",
		passwordConfiguredHint:
		  "留空将保留已保存的密码；修改 Host、Port、连接加密或用户名时必须重新输入密码。",
		passwordRequiredHint: "尚未保存密码。",
		clearSavedSMTPPassword: "清除已保存的 SMTP 密码",
		clearSavedIMAPPassword: "清除已保存的 IMAP 密码",
		clearSavedPasswordHint: "保存后删除该密码。仅可在邮件工作流关闭时操作。",
    ...
    communicationResults: {
      ...
      disabled: "处理回复前邮件工作流已停用",
      state_conflict: "申请已结束，无法再次处理",
      not_found: "申请已不存在",
      unavailable: "申请的分组已不可用",
      error: "处理异常",
    },
    errors: {
