export default {
  common: {
    ...
    total: 'Total',
    balance: 'Balance',
    ordinaryBalance: 'Regular balance',
    giftBalance: 'Gift balance',
    availableBalance: 'Available balance',
    frozenBalance: 'Frozen balance',
    frozenOrdinaryBalance: 'Frozen regular balance',
    frozenGiftBalance: 'Frozen gift balance',
    totalFrozenBalance: 'Total frozen',
    totalBalance: 'Total balance',
    balanceIncludingFrozen: 'Total including frozen',
    available: 'Available',
  ...
  auth: {
    ...
    promoCodeValid: 'Valid! You will receive ${amount} regular balance',
