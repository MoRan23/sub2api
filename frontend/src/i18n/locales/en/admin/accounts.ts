    ...
    accounts: {
      codexTurnState: {
        ...
        reasons: {
          ...
          account_cooldown: 'Account is cooling down', no_target_state: 'Response did not provide a target shape', collection_failed: 'Collection failed',
          collector_proxy_unavailable: 'Collector proxy unavailable', collection_timeout: 'Collection timed out', collector_auth_rejected: 'Credentials rejected; waiting for credentials or configuration to change',
          ...
          collector_proxy_not_configured: 'No collector proxy configured; learning from business responses only', account_unavailable: 'Account is unavailable for collection', idle: 'No collection needed',
