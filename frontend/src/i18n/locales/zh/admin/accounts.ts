export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintCreateDesc: '创建后由账号固定的 installation_id 与环境指纹共同组成账号级配置；会话 UUIDv7 和客户端身份由全局策略管理。',
        codexFingerprintEditDesc: '在此管理账号固定的 installation_id 与 UA 环境后缀；全局策略负责 UUIDv7 会话身份和客户端身份归一。',
        codexFingerprintPaused: 'Codex 指纹归一当前全局暂停。这里的账号配置仍可编辑和保存，重新开启后生效。',
        codexFingerprintShadowHint: '该影子账号继承母账号的 Codex 指纹配置。此处不展示或提交实际生效值；如需修改，请编辑母账号。',
        ...
        installationPinDesc: '默认开启。开启后本账号使用系统在创建时生成的专属 UUID，忽略客户端上报值；关闭则恢复透传。仅 OpenAI OAuth 账号生效。',
        ...
        installationRegenerateConfirm: '确定为此账号生成新的 installation_id 吗？后续新请求将使用新值。',
