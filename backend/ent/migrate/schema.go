...
var (
	...
	OpenaiOauthDailySessionAffinitiesTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			{
				Name:    "openaioauthdailysessionaffinity_account_id_api_key_id_logical_session_key",
				Unique:  true,
				Columns: []*schema.Column{OpenaiOauthDailySessionAffinitiesColumns[3], OpenaiOauthDailySessionAffinitiesColumns[4], OpenaiOauthDailySessionAffinitiesColumns[5]},
			},
			{
	...
	PaymentOrdersColumns = []*schema.Column{
		...
		{Name: "gift_ratio", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "gift_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
	...
	ProxiesColumns = []*schema.Column{
		...
		{Name: "status", Type: field.TypeString, Size: 20, Default: "active"},
		{Name: "route_generation", Type: field.TypeInt64, Default: 1},
		{Name: "expires_at", Type: field.TypeTime, Nullable: true},
	...
	RedeemCodesColumns = []*schema.Column{
		...
		{Name: "gift_ratio", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "gift_value", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
