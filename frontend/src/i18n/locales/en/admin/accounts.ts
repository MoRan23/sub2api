export default {
    accounts: {
      codexTurnState: {
        ...
        shapes: { target: 'Matches target shape', extended: 'Suspected abnormal shape', suspect: 'Suspected abnormal shape', invalid: 'Invalid shape', expired: 'Expired', unknown: 'Not observed' },
        ...
        outboundTitle: 'Actual outbound turn-state',
