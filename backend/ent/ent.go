...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			openaioauthdailysessionaffinity.Table: openaioauthdailysessionaffinity.ValidColumn,
			openaioauthdailysessionpool.Table:     openaioauthdailysessionpool.ValidColumn,
			openaioauthsyncsession.Table:          openaioauthsyncsession.ValidColumn,
