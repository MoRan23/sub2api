export default {
  promptAudit: {
    ...
    keyword: { category: '关键字拦截', description: '提示词命中管理员配置的关键字规则。', localPolicy: '本地关键字策略' },
    runtime: {
      title: '运行概览',
      description: '显示服务端当前生效状态；未保存的草稿不会改变这些数值。',
      process: '进程状态', mode: '生效模式', version: '生效 / 期望版本', workers: '活动 / 总 Worker',
      queue: '活动任务 / 容量', dependencies: '依赖', keywordBlocking: '关键字拦截', guardMetrics: '审核指标', latest: '最近处理与错误',
    ...
    metrics: { total: '总计', allowed: '放行', flagged: '标记', blocked: '阻止', keywordBlocked: '关键字阻止', unavailable: '不可用', timeouts: '超时', failovers: '故障切换' },
    pool: {
    ...
    events: {
      ...
      guardReturn: '审计结果',
      guardReturnHint: '展示模型或本地关键字策略的结构化结果，不含原始响应体。',
      riskSummaries: '风险摘要',
      evidence: '脱敏证据',
      score: '分数',
