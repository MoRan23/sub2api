export default {
    accounts: {
      codexTurnState: {
        ...
        observationScopeHint: 'Summarizes normal business responses on this instance without storing tokens or making collection requests, independently of fingerprint capture. Resets on restart; observations are not usable cached state.',
