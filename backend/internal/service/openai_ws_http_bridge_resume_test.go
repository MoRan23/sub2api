...
func TestOpenAIWSHTTPBridgeLaterTurn429RetriesCurrentTurnOnReplacementAccount(t *testing.T) {
	...
	wsServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		SetOpenAIOAuthIdentityCapture(ginCtx, CaptureOpenAIOAuthIdentity(ginCtx, firstMessage, "ws-failover-test"))
		...
		retryCapture, captureOK := OpenAIWSCurrentTurnRetryIdentityCapture(proxyErr)
		if !captureOK {
