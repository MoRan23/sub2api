...
func selectOpenAICompactionSchedulerTestAccount(t *testing.T, svc *OpenAIGatewayService, groupID int64, capability OpenAIEndpointCapability, requireCompact bool) (*AccountSelectionResult, error) {
	t.Helper()
...
func TestOpenAIGatewayService_SelectAccountWithScheduler_NativeCompactionIgnoresLegacyCompactProbe(t *testing.T) {
	for _, advanced := range []bool{false, true} {
		t.Run(map[bool]string{false: "legacy_scheduler", true: "advanced_scheduler"}[advanced], func(t *testing.T) {
			...
			selection, err := selectOpenAICompactionSchedulerTestAccount(t, svc, 91007, OpenAIEndpointCapabilityRemoteCompactionV2, false)
			require.NoError(t, err)
			require.NotNil(t, selection)
...
func TestOpenAIGatewayService_SelectAccountWithScheduler_NativeCompactionAllowsForceOff(t *testing.T) {
	for _, advanced := range []bool{false, true} {
		t.Run(map[bool]string{false: "legacy_scheduler", true: "advanced_scheduler"}[advanced], func(t *testing.T) {
			...
			selection, err := selectOpenAICompactionSchedulerTestAccount(t, svc, 91008, OpenAIEndpointCapabilityRemoteCompactionV2, false)
			require.NoError(t, err)
			require.NotNil(t, selection)
...
func TestOpenAIGatewayService_SelectAccountWithScheduler_NativeCompactionUsesIndependentProbe(t *testing.T) {
	for _, advanced := range []bool{false, true} {
		t.Run(map[bool]string{false: "legacy_scheduler", true: "advanced_scheduler"}[advanced], func(t *testing.T) {
			resetOpenAIAdvancedSchedulerSettingCacheForTest()
			svc := newOpenAICompactionSchedulerTestService([]Account{
				{
					...
					Extra: map[string]any{
						"openai_responses_supported":              true,
						OpenAIRemoteCompactionV2SupportedExtraKey: false,
					},
				},
			}, advanced)

			selection, err := selectOpenAICompactionSchedulerTestAccount(t, svc, 91011, OpenAIEndpointCapabilityRemoteCompactionV2, false)
...
func TestOpenAIGatewayService_SelectAccountWithScheduler_LegacyCompactionIgnoresNativeProbe(t *testing.T) {
	for _, advanced := range []bool{false, true} {
		t.Run(map[bool]string{false: "legacy_scheduler", true: "advanced_scheduler"}[advanced], func(t *testing.T) {
			resetOpenAIAdvancedSchedulerSettingCacheForTest()
			svc := newOpenAICompactionSchedulerTestService([]Account{{
			...
			selection, err := selectOpenAICompactionSchedulerTestAccount(t, svc, 91012, OpenAIEndpointCapabilityResponses, true)
			require.NoError(t, err)
			require.NotNil(t, selection)
...
func TestOpenAIGatewayService_SelectAccountWithScheduler_NativeCompactionRequiresResponsesCapability(t *testing.T) {
	for _, advanced := range []bool{false, true} {
		t.Run(map[bool]string{false: "legacy_scheduler", true: "advanced_scheduler"}[advanced], func(t *testing.T) {
			...
			selection, err := selectOpenAICompactionSchedulerTestAccount(t, svc, 91009, OpenAIEndpointCapabilityRemoteCompactionV2, false)
			require.ErrorIs(t, err, ErrNoAvailableAccounts)
...
func TestOpenAIGatewayService_SelectAccountWithScheduler_LegacyCompactionKeepsCompactEligibility(t *testing.T) {
	for _, advanced := range []bool{false, true} {
		t.Run(map[bool]string{false: "legacy_scheduler", true: "advanced_scheduler"}[advanced], func(t *testing.T) {
			...
			selection, err := selectOpenAICompactionSchedulerTestAccount(t, svc, 91010, OpenAIEndpointCapabilityResponses, true)
