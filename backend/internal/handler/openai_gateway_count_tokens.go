...
func (h *OpenAIGatewayHandler) ResponsesInputTokens(c *gin.Context) {
	...
	if h.rejectResponsesInputTokensCompactionTrigger(c, body) {
		return
	}
...
func (h *OpenAIGatewayHandler) rejectResponsesInputTokensCompactionTrigger(c *gin.Context, body []byte) bool {
