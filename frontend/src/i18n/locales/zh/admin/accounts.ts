    ...
    accounts: {
      codexTurnState: {
        ...
        reasons: {
          ...
          account_cooldown: '账号冷却中', no_target_state: '本次响应未取得目标形态', collection_failed: '采集失败',
          collector_proxy_unavailable: '采集代理不可用', collection_timeout: '采集超时', collector_auth_rejected: '凭据被拒绝，等待更新凭据或配置',
          collector_rate_limited: '采集受到限流',
          waiting_business_response: '等待首次业务响应', queued: '已排队等待采集', waiting_business: '等待业务请求完成', collecting: '采集中',
          collector_proxy_not_configured: '未配置采集代理，仅从业务响应学习', account_unavailable: '账号暂不满足采集条件', idle: '当前无需采集',
