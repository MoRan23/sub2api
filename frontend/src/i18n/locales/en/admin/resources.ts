export default {
    ...
    redeem: {
      ...
      codeType: 'Code Type',
      amount: 'Amount ($)',
      ordinaryAmount: 'Regular balance',
      giftAmount: 'Gift balance',
      totalAmount: 'Total credit',
      giftRatio: 'Gift Ratio',
      giftRatioHint: 'Available only for balance codes. Range 0–100% with up to 4 decimal places.',
      giftRatioInvalid: 'Gift ratio must be between 0–100% with up to 4 decimal places',
      giftPreview: 'Regular ${ordinary} + gift ${gift} = total ${total}',
      value: 'Value',
      count: 'Count',
