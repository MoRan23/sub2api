export default {
    ...
    riskControl: {
      ...
      cyberPolicyWhitelist: 'Cyber Policy Whitelist Notifications',
      cyberPolicyWhitelistHint: 'Hits from whitelisted users are still recorded but never count toward auto-ban. Emails go to the user and the configured recipients below.',
      cyberPolicyWhitelistUsers: 'Whitelisted Users',
      cyberPolicyNotificationEmails: 'Additional Notification Emails',
      cyberPolicyNotificationEmailPlaceholder: 'Enter an email and add it',
      cyberPolicyAddNotificationEmail: 'Add Email',
      cyberPolicyRemoveNotificationEmail: 'Remove notification email',
      cyberPolicyInvalidNotificationEmail: 'Enter a valid notification email',
      cyberPolicyNotificationEmailsHint: 'Hits from groups outside the audit scope do not send notifications.',
      ...
      groupScopeHint: 'Switch on for all groups, or turn off to choose specific groups. This scope also applies to content-audit and cyber_policy records.',
      selectedGroups: 'Selected Groups',
      searchGroups: 'Search group name or platform',
      noGroups: 'No groups available',
      contentModerationWhitelist: 'Moderation Allowlist',
      contentModerationWhitelistHint: 'Requests from these users are still audited asynchronously and hits are recorded, but they are always allowed immediately and never accrue violations or trigger automatic bans. Prompt audit and cyber policy are unaffected.',
      contentModerationWhitelistUsers: 'Allowed Users',
    ...
    subscriptions: {
      ...
      monthly: 'Monthly',
      total: 'Total',
      expiringQuotaHint: '${amount} quota expires in {time}',
