export default {
    accounts: {
      codexTurnState: {
        ...
        outboundObservedLength: 'Outbound length',
        cacheSummary: 'Cache',
        ...
        reasons: {
          ...
          collector_proxy_auth_required: 'Collector proxy requires authentication (407)',
        ...
        reasonHints: {
          ...
          collector_proxy_auth_required: 'The proxy returned HTTP 407. Check the username and password for the selected collector proxy.',
