  ...
  keys: {
    ...
    useKeyModal: {
      ...
      openai: {
        ...
        contextManagementTitle: 'Optional: enable PAT context management',
        contextManagementDescription: 'Use this only after the administrator enables the PAT context-management proxy. personal_access_token must take precedence over OPENAI_API_KEY; Codex calls whoami for subscription detection. This example disables WebSockets and uses HTTP streaming. After making changes, completely quit and restart Codex and all VS Code windows.',
        contextManagementUnsetTitle: 'Remove CODEX_AUTHAPI_BASE_URL configuration',
        contextManagementUnsetHintWindows: 'Remove the variable from the current PowerShell session and persistent user environment. Then completely quit and restart Codex and all VS Code windows.',
        contextManagementUnsetHintUnix: 'Remove the variable from the current terminal session. If you added an export to ~/.bashrc, ~/.zshrc, or another startup file, also remove that line. Then completely quit and restart Codex and all VS Code windows.',
        contextManagementExample: "{'{'}\n  \"personal_access_token\": \"Your API key\",\n  \"OPENAI_API_KEY\": \"Your API key\"\n{'}'}\n\nmodel_provider = \"openai-http\"\nmodel = \"gpt-5.5\"\ndisable_response_storage = true\nmodel_catalog_json = \"~/.codex/codex-models.json\"\nnetwork_access = \"enabled\"\nwindows_wsl_setup_acknowledged = true\n\n[model_providers.openai-http]\nname = \"OpenAI\"\nbase_url = \"<api-address>/backend-api/codex\"\nwire_api = \"responses\"\nrequires_openai_auth = true\nsupports_websockets = false\n\n[features]\ngoals = true\n\n[features.context_management]\nexperimental_mode = true\n\n[analytics]\nenabled = false",
