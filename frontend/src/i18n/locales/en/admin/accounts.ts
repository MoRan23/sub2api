export default {
    accounts: {
      codexTurnState: {
        ...
        description: 'Real business requests trigger parallel collection. Token and cookie packages are shared across systems for each credential account and final model in the system list. Requests continue without a cache. Disabling this feature stops cookie pooling, replacement and storage.',
        ...
        lifetimePolicyHint: 'Tokens are locally valid for 240 seconds from issue time. Active models collect again 30 seconds after success, with a 12-second attempt limit, and stop after 30 minutes without business requests. Packages are reusable until the earliest token or cookie expiry. These are local policies, not confirmed upstream lifetimes.',
        ...
        cookieSources: { none: 'Not sent', bundle: 'This request’s token package', persistent: 'Persistent pool', memory: 'Process session pool', mixed: 'Persistent and process session pools', unknown: 'Not recorded' },
        cookieReasons: {
        ...
        reasons: {
          ...
          business_active: 'A real business request triggered collection', refresh: 'Scheduled refresh for an active model',
        ...
        reasonHints: {
          ...
          refresh: 'Collection resumes 30 seconds after the last success and stops after 30 minutes without business requests for this model. This is a scheduled refresh, not an error backoff.',
