export default {
    accounts: {
      codexTurnState: {
        ...
        responseEligibility: 'Account target shape match',
        ...
        reasonHints: {
          ...
          no_target_state: 'No usable target state was returned. It may be missing or fail shape or issue-time checks. Compare the recent observations on the right.',
          target_still_expiring: 'The returned state is still near expiry, so renewal is unfinished. An existing valid cache remains usable.',
