export default {
    accounts: {
      codexTurnState: {
        ...
        observationDisabled: 'Fingerprint observation is off',
        observationEmpty: 'No observations on this instance yet',
        observationScopeHint: 'Shows recent response summaries from this instance only and resets on restart. Observed values are not usable cached state.',
