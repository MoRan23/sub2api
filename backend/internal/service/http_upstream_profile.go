...
const (
	...
	HTTPUpstreamProfileCodexAuxiliary HTTPUpstreamProfile = "codex_auxiliary"
...
func HTTPUpstreamProfileFromContext(ctx context.Context) HTTPUpstreamProfile {
	...
	switch profile {
	case HTTPUpstreamProfileOpenAI, HTTPUpstreamProfileCodexAuxiliary, HTTPUpstreamProfileGrok, HTTPUpstreamProfileLongStream:
		return profile
	default:
		return HTTPUpstreamProfileDefault
	}
