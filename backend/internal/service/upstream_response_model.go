...
// resolvedOpenAIUpstreamServiceTierFromObserver retains the final tier carried
// by the outbound request. The observer argument is intentionally not folded
...
// resolvedOpenAIUpstreamServiceTier is the Gin-context counterpart. Response
// observation remains available through observedUpstreamResponseServiceTier.
