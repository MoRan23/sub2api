export default {
  common: {
    ...
    frozenBalance: '冻结金额',
    frozenOrdinaryBalance: '冻结普通余额',
    frozenGiftBalance: '冻结赠送余额',
    totalFrozenBalance: '冻结合计',
    totalBalance: '总余额',
    balanceIncludingFrozen: '含冻结总额',
    available: '可用',
  ...
  auth: {
    ...
    promoCodeValid: '有效！注册后将获得 ${amount} 普通余额',
