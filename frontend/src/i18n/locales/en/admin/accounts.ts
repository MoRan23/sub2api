export default {
    accounts: {
      codexTurnState: {
        ...
        description: 'Learn from normal responses first and reuse within the credential account and final upstream model. Requests continue when no cache is available.',
        ...
        status: 'Status',
        states: { ready: 'Matches target shape', expired: 'Expired', missing: 'Awaiting state', paused: 'Collection paused' },
