...
func providePrivacyClientFactory(cookies *openaicookies.Manager) service.PrivacyClientFactory {
	return func(proxyURL string) (*req.Client, error) {
		return repository.CreatePrivacyReqClientWithCookies(proxyURL, cookies)
	}
}
...
func provideCleanup(
	...
	groupApplicationWorker *service.GroupApplicationWorker,
	...
	return func() {
		...
		parallelSteps := []cleanupStep{
			...
			{"GroupApplicationWorker", func() error {
				if groupApplicationWorker != nil {
					groupApplicationWorker.Stop()
				}
				return nil
			}},
			...
			{"OpenAIOutboundSessionV1Cleanup", func() error {
				if openAIOutboundSessionV1Cleanup != nil {
					openAIOutboundSessionV1Cleanup.Stop()
				}
				return nil
			}},
