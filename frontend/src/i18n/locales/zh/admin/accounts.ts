export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintCreateDesc: '创建后自动生成 Windows、macOS、Linux 三套固定安装身份；默认系统为 Windows。会话及客户端身份由全局策略管理。',
        ...
        osProfilesDescription: '每个系统的 User-Agent 与 installation_id 持久保存；无法识别请求系统时使用默认系统。',
        defaultOS: '默认系统',
