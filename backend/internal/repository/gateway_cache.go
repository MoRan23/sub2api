...
func (c *gatewayCache) SaveLiveCall(ctx context.Context, record *service.LiveCallRecord, ttl time.Duration) error {
	...
	values := map[string]any{
		...
		"credential_os":            record.CredentialOS,
		"credential_owner_id":      record.CredentialOwnerID,
		"authorization_generation": record.AuthorizationGeneration,
	}
...
func (c *gatewayCache) GetLiveCall(ctx context.Context, callHash string) (*service.LiveCallRecord, error) {
	...
	return &service.LiveCallRecord{
		...
		CredentialOS:            values["credential_os"],
		CredentialOwnerID:       parseInt("credential_owner_id"),
		AuthorizationGeneration: values["authorization_generation"],
	}, nil
}
