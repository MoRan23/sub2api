export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintCreateDesc: 'Creation generates separate Windows, macOS and Linux installation identities. Windows is the default. Global policy manages sessions and client identity.',
        ...
        osProfilesDescription: 'Each system has a persistent User-Agent and installation_id. Requests with an unknown system use the default.',
