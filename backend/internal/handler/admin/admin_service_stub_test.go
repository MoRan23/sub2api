...
func (s *stubAdminService) PersistOpenAIOAuthRefreshCredentials(_ context.Context, expected *service.Account, credentials map[string]any) (*service.Account, bool, error) {
	if s.updateAccountErr != nil {
