  ...
  keys: {
    ...
    useKeyModal: {
      ...
      openai: {
        ...
        contextManagementDescription: 'Use this only after the administrator enables the PAT context-management proxy. personal_access_token must take precedence over OPENAI_API_KEY; Codex calls whoami for subscription detection. Restart Codex after editing these files.',
        contextManagementExample: "{'{'}\n  \"personal_access_token\": \"Your API key\",\n  \"OPENAI_API_KEY\": \"Your API key\"\n{'}'}\n\nopenai_base_url = \"<api-address>/backend-api/codex\"\n\n[features.context_management]\nexperimental_mode = true\n\n[features.token_budget]\nenabled = true\nuse_history_notes_extension = true\n\n# Windows\nsetx CODEX_AUTHAPI_BASE_URL \"https://your-sub2api-host\"\n# macOS/Linux\nexport CODEX_AUTHAPI_BASE_URL=\"https://your-sub2api-host\"",
