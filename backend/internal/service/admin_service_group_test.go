...
func TestAdminServiceSimpleModeNormalizesAllUnsupportedCreateFieldsDirectly(t *testing.T) {
	...
	input := &CreateGroupInput{
		...
		DailyLimitUSD: &one, TotalLimitUSD: &one, LongContextPricingEnabled: true,
	...
	require.Nil(t, created.TotalLimitUSD)
...
func TestAdminServiceSimpleModeNormalizesAllUnsupportedUpdateFieldsDirectly(t *testing.T) {
	...
	input := &UpdateGroupInput{
		...
		DailyLimitUSD: &one, TotalLimitUSD: &one, LongContextPricingEnabled: &truth, ModelPricing: &pricing,
	...
	existing.SubscriptionType = SubscriptionTypeTotalQuota
	existing.TotalLimitUSD = new(25.0)
	...
	require.Equal(t, SubscriptionTypeTotalQuota, updated.SubscriptionType)
	require.Equal(t, 25.0, *updated.TotalLimitUSD)
}
