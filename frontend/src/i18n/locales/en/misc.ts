export default {
  ...
  payment: {
    ...
    admin: {
      ...
      refundSuccessWithDeductions: 'Refund successful. Recovered {ordinary} ordinary balance and {gift} gift balance ({total} total).',
      ...
      deductBalanceHint: 'Recover ordinary and gift balances separately in proportion to the refund',
      userBalance: 'User Balance',
      userOrdinaryBalance: 'Available Ordinary Balance',
      userGiftBalance: 'Available Gift Balance',
      loadingWallet: 'Loading current wallet balances...',
      orderAmount: 'Order Amount',
      insufficientBalance: 'Insufficient balance — will deduct to $0',
      ordinaryBalanceInsufficient: 'Ordinary balance is insufficient: ${available} available, ${required} required.',
      giftBalanceInsufficient: 'Gift balance is insufficient: ${available} available, ${required} required.',
      estimatedOrdinaryRecovery: 'Estimated Ordinary Recovery',
